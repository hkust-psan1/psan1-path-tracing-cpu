...
QMAKE    = /usr/bin/qmake
FYP.xcodeproj/project.pbxproj: FYP.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o FYP.xcodeproj/project.pbxproj FYP.pro
